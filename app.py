...
def predict_result(model, run_time, probs, img):
    class_list = {'Z': 'Z', 'M': 'M', 'H': 'H', 'O': 'O', 'P': 'P', 'K': 'K', 'U': 'U', 'W': 'W', 'L': 'L', 'Q': 'Q', 'R': 'R', 'space': 'space', 'D': 'D', 'F': 'F', 'del': 'del', 'nothing': 'nothing', 'G': 'G', 'A': 'A', 'T': 'T', 'C': 'C', 'E': 'E', 'S': 'S', 'X': 'X', 'V': 'V', 'N': 'N', 'I': 'I', 'Y': 'Y', 'J': 'J', 'B': 'B', 'other': 'other'}
